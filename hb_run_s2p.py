...
from suite2p.registration import register, metrics, reference
from suite2p.extraction import extract, dcnv
from suite2p import utils
from hbreference import hb_register_binary
try:
...
def hb_run_s2p(ops={},db={}):
    ...
    while ipl<len(ops1):
        ...
        if not flag_binreg:
            ...
            t11=time.time()
            print('----------- REGISTRATION')
            ops1[ipl] = hb_register_binary(ops1[ipl]) # register binary
            np.save(fpathops1, ops1) # save ops1
